...
declare module '@vue-router/routes' {
  export interface RouteNamedMap {
    ...
    'formlogin': RouteRecordInfo<'formlogin', '/formlogin', Record<never, never>, Record<never, never>>,
    'halaman': RouteRecordInfo<'halaman', '/halaman', Record<never, never>, Record<never, never>>,
    'kalkulator': RouteRecordInfo<'kalkulator', '/kalkulator', Record<never, never>, Record<never, never>>,
